...
// --- 1. VOLUME CONFIGURATION (DO NOT ALTER) ---
// Using the exact mount path from your Railway settings
...
// These tell the server to serve HTML files, not the script text
app.get('/', (req, res) => {
...
try {
    ...
    console.error("CRITICAL: GCP_SA_KEY Auth Failed."); 
}
